<?php
$apiKey = "06c834ba50e1be764d91c5cc3cad1f8e";
$cityId = "361058";
...
<form method="get">
    <select name="cities" >
        <option value="361058" name="alex">Alexandria</option>
        <option value="361055" name="ismalia">Ismailia</option>
        <option value="4104031" name="cairo">Cairo</option>
    </select>
